...
# data options
train_data=${DATAPATH}/datasets/Flickr8K_CN/lmdb/train
val_data=${DATAPATH}/datasets/Flickr8K_CN/lmdb/valid # if val_data is not specified, the validation will be automatically disabled
